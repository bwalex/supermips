...
PORT_CFLAGS =       -O3 -fomit-frame-pointer -funroll-loops -mno-branch-likely -mno-dsp -mno-dspr2 -mno-float
...
PORT_SRCS = $(PORT_DIR)/core_portme.c $(PORT_DIR)/ee_printf.c $(PORT_DIR)/startup.s
vpath %.c $(PORT_DIR)
vpath %.s $(PORT_DIR)
